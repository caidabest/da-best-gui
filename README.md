...
--------------------------------------------------------------------
local RenUi = library:AddWindow("VPHNG Hub",Enum.KeyCode.RightControl)
--------------------------------------------------------------------
local Main = RenUi:AddTab("cho de farm dcm","6026568198")
local Combat = RenUi:AddTab("nguoi choi ko hieu","7251993295")
local Stats = RenUi:AddTab("nang diem","7040410130")
local Teleport = RenUi:AddTab("di chuyen super nahn","6035190846")
local Dungeon = RenUi:AddTab("ko lam doi co an raid","7044284832")
local DevilFruit = RenUi:AddTab("trai ac quy","7044233235")
local Shop = RenUi:AddTab("cua hang haha dit me may","6031265976")
local Misc = RenUi:AddTab("ko biet nghia haha","6034509993")
--------------------------------------------------------------------
Main:AddSeperator("à¸¢à¸´à¸™à¸”à¸µà¸•à¹‰à¸­à¸™à¸£à¸±à¸šà¸ªà¸¹à¹ˆVPHNG Hubà¸„à¸™à¸—à¸³à¸ªà¸„à¸£à¸´à¸›à¸•à¹Œà¹€à¸›à¹‡à¸™à¸„à¸™à¹„à¸—à¸¢à¸™à¸°à¸„à¸£à¸±à¸š")
Main:AddSeperator("Settings Farm")

Time = Main:AddLabel("thoi gian sever")
...
Main:AddButton("tat tieng dit cu may",function()
...
Main:AddButton("xoa hieu ung", function()
game:GetService("ReplicatedStorage").Assets.GUI.DamageCounter.Enabled = false
end)

Main:AddSeperator("danh nhu dio and Settings")

Main:AddToggle("nhanh hon dio(à¸¢à¸±à¸‡à¹ƒà¸Šà¹‰à¹„à¸¡à¹ˆà¹„à¸”à¹‰à¸™à¸°à¸„à¸£à¸±à¸š)",function()
...
Main:AddToggle("tu dong Spawn Points",true,function(value)
...
Main:AddToggle("mang may con bot",true,function(value)
...
local AutoFarm = Main:AddToggle("dit me tu dong farm level",_G.AutoFarm,function(value)
_G.AutoFarm = value
...
Misc:AddToggle("tam nhin haki quan sat vo tan",getgenv().InfiniteObRange,function(value)
...
Misc:AddToggle("ko gioi han soru",getgenv().InfSoru,function(value)
...
Misc:AddToggle("di tren mat nuoc",_G.WalkWater,function(value)
_G.WalkWater = value
end)
...
Misc:AddToggle("bay",false,function(value)
Fly = value
end)
